...
import pokakLogo from '../assets/lo.png'; // Path to your logo

const Footer = () => {
  return (
    // mt-32 nalkunnathu vazhi Grocery section-um Footer-um thammil nalla space undakum
    // mb-0 nalkunnathu thazhe white space ozhivakkan aanu
    <footer className="w-full bg-[#45b55e] text-white pt-16 pb-12 mt-70 mb-0">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        
        <div className="flex flex-col md:flex-row justify-between gap-12 md:gap-8">
          
          {/* 1. Left Section: Logo & Social Icons */}
